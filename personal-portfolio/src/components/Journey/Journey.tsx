    ...
    <div className="w-full h-full flex justify-center">
      <div className="w-10/12 h-full flex justify-center ">
        <ul className="before:content-[''] before:h-full before:w-1 relative before:absolute before:bg-pink-500">
          <li className="before:content-[''] before:border-r-[10px] top-28 before:border-b-[20px] before:border-l-[10px] before:border-t-transparent before:border-r-transparent before:border-b-slate-blue-explorer before:border-l-transparent before:-rotate-90 before:h-8 before:-z-0 before:absolute before:-left-3.5 absolute  left-3.5 w-96 h-80 bg-slate-blue-explorer p-4 rounded-xl text-white">
          ...
          <li className="before:content-[''] before:border-r-[10px] before:border-b-[20px] before:border-l-[10px] before:border-t-transparent before:border-r-transparent before:border-b-slate-blue-explorer before:border-l-transparent before:rotate-90  before:h-8 before:-z-0 before:absolute before:-right-3.5 absolute top-96 right-3.5 w-96 h-80 bg-slate-blue-explorer p-4 rounded-xl text-white">
            <div className="flex items-start justify-between w-full">
              <h1 className="text-xl font-bold">
          ...
          <li className="before:content-[''] before:border-r-[10px] top-[36rem] before:border-b-[20px] before:border-l-[10px] before:border-t-transparent before:border-r-transparent before:border-b-slate-blue-explorer before:border-l-transparent before:-rotate-90 before:h-8 before:-z-0 before:absolute before:-left-3.5 absolute  left-3.5 w-96 h-80 bg-slate-blue-explorer p-4 rounded-xl text-white">
            <div className="flex items-start justify-between w-full">
              <h1 className="text-xl font-bold">
                College:
                <br />
